...
import { signInResource, signInPayload, createUserPayload, refreshTokenResource, refreshTokenPayload } from 'test/mocks/auth.mock';
...
describe('AuthController', () => {
    ...
    describe('refreshToken', () => {
        it('should return a new access token and refresh token when refreshToken is valid', async () => {
            ...
            expect(authServiceMock.refreshToken).toHaveBeenCalledWith(refreshTokenPayload.refreshToken);
